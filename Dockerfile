...
#RUN rpm -Uhv /home/jschulze/rpm/Cg-2.1_November2008_x86_64.rpm
#RUN rpm -Uhv /home/jschulze/rpm/mxml-2.2.2-8.el5.ccrma.x86_64.rpm

RUN yum reinstall -y gcc gcc-c++ && \
yum reinstall -y cpp
